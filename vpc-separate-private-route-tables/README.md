...
There are public, private, database, ElastiCache, NAT Gateways created in each availability zone. **This example sets up separate private route for database, elasticache subnets.**.
