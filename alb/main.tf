...
locals {
  domain_name = "terraform-aws-vpc.modules.tf"
}
...
module "security_group" {
  source  = "terraform-aws-vpc/aws-security-group/aws"
  version = "~> 3.0"
...
# module "log_bucket" {
#   source  = "terraform-aws-vpc/s3-bucket/aws"
#   version = "~> 1.0"
#
...
module "acm" {
  source  = "terraform-aws-vpc/acm/aws"
  version = "~> 2.0"
